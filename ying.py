...
def Ying_2017_CAIP(img, mu=0.5, a=-0.3293, b=1.1258):
    ...
    t_b = np.max(I, axis=2)
    size = (np.array(img.size) * 0.99999).astype(int)
    t_our = skimage.transform.resize(img, size, order=3)
...
def main():
    img_name = "C:/Users/izhak/OneDrive/Desktop/snapify/lifney/IMG_0275.jpg"
